...
/**
 * \file
 * \brief ROS 2 integration of the 2D FastSlam algorithm.
 */
...
private:
    ...
    std::vector<std::pair<double, double>> laser_to_cartesian(const sensor_msgs::msg::LaserScan::SharedPtr msg);
    state_type tf_to_se2(const geometry_msgs::msg::Transform& t);

    std::unique_ptr<FastSLAM> slam_;
