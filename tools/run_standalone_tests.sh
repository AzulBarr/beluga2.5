...
for beluga_test_name in probability_matching hierarchical_bayes tracking_accuracy motion_filter loop_belief output_selection pose_graph_residual proposal_pose robust_tracking late_run grid_update loop_search; do
